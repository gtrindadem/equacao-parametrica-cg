...
public class Desenho extends Path2D.Double {
	...
	public Desenho(int aQuantidadePontos) {
		...
		centro = new Point2D.Double(300, 300);
		raio = 100;
	...
	private void updateCirculo() {
		reset();
		double intervaloMinimo = 0, intervaloMaximo = 2*Math.PI;
		double incremento = intervaloMaximo/quantidadePontos;
	...
	public void updateRaio(double escal) {
		raio = escal;
	}
